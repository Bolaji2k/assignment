...
class Student_Management:
      def __init__(self, students = students) -> None:
...
print(admin.register_student("John"))
print(admin.register_student("James"))
print(admin.register_student("Lebron"))
print(admin.register_student("bronny"))
print(admin.record_grade("1",50,90,70,90))
print(admin.record_grade("2",100,100,90))
print(admin.record_grade("3",100,100,10))
print(admin.record_grade("4",100,100,90))
